          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Registros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index1.php">Orden de carga</a></li>
              
                    </ul>
                  </li>
                  <li><a><i class="fa fa-home"></i> Translados <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Operaciones activas</a></li>
                      
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Compras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">Ordenes de compra</a></li>
                      <li><a href="media_gallery.html">Compras por pagar</a></li>
                      <li><a href="typography.html">Insumos</a></li>
                      <li><a href="icons.html">Proveedores</a></li>
                      <li><a href="glyphicons.html">Consumos</a></li>
                      
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Finanzas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Facturación</a></li>
                      <li><a href="tables_dynamic.html">Pagos</a></li>
                      <li><a href="tables_dynamic.html">Cuentas por pagar</a></li>
              ...
              <div class="menu_section">
                <h3>Sistema</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> Catalogo <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="e_commerce.html">E-commerce</a></li>
                      <li><a href="projects.html">Projects</a></li>
                      <li><a href="project_detail.html">Project Detail</a></li>
